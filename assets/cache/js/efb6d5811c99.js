...
return console.log('No tag');var tag=$('#fftf_donate_tag').html();console.log('tag:',tag);var options={tag:tag};FFTFDonate.init(options).test($('#fftf_donate')[0],'stripe10_vs_external',[{name:'stripe10',ui:'button',buttonText:'Donate $10',amount:10,checkoutFlow:'stripe'},{name:'external',ui:'button',buttonText:'Donate'}]);}
