...
$('input').placeholder();if(qs.t&&qs.t.match(/[0-9A-z]+/)){$('form').each(function(){var $form=$(this);if(!$form.find('[name=t]').length){var $input=$('<input />');$input.attr('name','t');$input.attr('type','hidden');$input.val(qs.t);$form.append($input);}});}
