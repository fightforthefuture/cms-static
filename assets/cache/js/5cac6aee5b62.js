...
$('input').placeholder();var socialSites=['google-plus','facebook','tumblr','twitter'];for(var i in socialSites){var target='.social-'+socialSites[i];$(target).attr('href',$(target).attr('href').split('%3Ft%3D')[0]);}
